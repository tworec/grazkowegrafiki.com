...
- 2026-09-19: **Etap 4 zrobiony** (combo pazura, ogon co 3 s z odrzutem, ogień trzymany, strzelec/szarżujący/tarczownik/boss, fale z 9 s przerwą i odliczaniem). Nowi wrogowie korzystają tymczasowo ze sprite'a robota z przesunięciem barwy.
- 2026-09-19: **Cykl chodu tyranozaura gotowy.** Przepis, który zadziałał: nowy wątek, jedna klatka na prompt, i w KAŻDYM prompcie reguła okluzji — noga bliższa przed tułowiem w pełnym kolorze, dalsza za tułowiem, przyciemniona o 25% i częściowo zasłonięta. Weryfikacja przez `tools/leg_tone.py`: jasność nóg w połowie przedniej minus tylnej daje +29,9 dla jednej pozy kontaktu i −29,8 dla drugiej, czyli nogi faktycznie się zamieniają. **Różnica pikselowa między pozami kontaktu jest złym kryterium** — w poprawnym cyklu obie mają ten sam rozstaw stóp.
- 2026-09-19: **Etap 5 zrobiony** (ekran startowy z wyborem gatunku i rekordami, wybór 1 z 3 ulepszeń przy awansie, pauza, katalog 7 ulepszeń w `js/upgrades.js`).
